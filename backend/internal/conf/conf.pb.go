...
type Data_Database struct {
	...
	MaxOpenConn int32  `protobuf:"varint,8,opt,name=max_open_conn,json=maxOpenConn,proto3" json:"max_open_conn,omitempty"`
	MaxIdleConn int32  `protobuf:"varint,9,opt,name=max_idle_conn,json=maxIdleConn,proto3" json:"max_idle_conn,omitempty"`
}
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x6e, 0x18, 0x09, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x6d, 0x61, 0x78, 0x49, 0x64, 0x6c, 0x65,
